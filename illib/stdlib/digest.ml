...
(* $Id: digest.ml,v 1.2 2006/07/23 03:04:14 montela Exp $ *)

(* Message digest (MD5) *)

type t = string

external unsafe_string: string -> int -> int -> t =
"string" "CamIL.Md5" "md5_string" "string" "int" "int" 


external channel: in_channel -> int -> t = 
"string" "CamIL.Md5" "md5_chan" "class System.IO.BinaryReader" "int" 
