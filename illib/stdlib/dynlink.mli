...
(* $Id: dynlink.mli,v 1.2 2004/06/22 10:32:13 montela Exp $ *)

(** Dynamic loading of bytecode object files. *)

val init : unit -> unit (* CAMILDOC ! [Does nothing, for compatibility only] *)
(** Initialize the library. Must be called before [loadfile]. *)

val loadfile : string -> unit  (* CAMILDOC ! *)
...
val loadfile_private : string -> unit  (* CAMILDOC ! *)
...
val add_available_units : (string * Digest.t) list -> unit (* CAMILDOC ! *)
...
val allow_unsafe_modules : bool -> unit (* CAMILDOC ! *)
