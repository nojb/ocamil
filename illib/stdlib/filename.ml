...
(* $Id: filename.ml,v 1.2 2003/09/16 14:02:33 montela Exp $ *)
...
*)
external random_seed: unit -> int = 
"int" "CamIL.Sys" "sys_random_seed" "void";;
...
(*      close_desc(open_desc name [Open_wronly; Open_creat; Open_excl] 0o600); *)
      close_out (open_out_gen [Open_wronly; Open_creat; Open_excl] 0o600 name);
      name
    with Sys_error _ ->
      try_name (counter + 1)
  in try_name 0
