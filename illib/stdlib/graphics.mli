...
(* $Id: graphics.mli,v 1.3 2006/06/10 09:28:20 montela Exp $ *)

(** Machine-independent graphics primitives. *)

exception Graphic_failure of string (* CAMILDOC ! *)
...
external draw_char : char -> unit = (* CAMILDOC ! *)
 "void" "CamIL.Graphics" "gr_draw_char" "int"
(** See {!Graphics.draw_string}.*)

val draw_string : string -> unit  (* CAMILDOC ! *)
...
external make_image : color array array -> image = (* CAMILDOC ! *)
...
external blit_image : image -> int -> int -> unit = (* CAMILDOC ! *)
...
(*external remember_mode : bool -> unit =
   "void" "CamIL.Graphics" "gr_remember_mode" "bool" *)
