...
(* $Id: string.ml,v 1.10 2006/07/23 03:04:14 montela Exp $ *)
...
external create: int -> string = "char[]" "CamIL.String" "string_create" "int" 
external unsafe_get : string -> int -> char = "%string_unsafe_get"
external unsafe_set : string -> int -> char -> unit = "%string_unsafe_set"
external unsafe_blit : string -> int -> string -> int -> int -> unit = "void" "CamIL.String" "blit_string" "string" "int" "char[]" "int" "int"
external unsafe_fill : string -> int -> int -> char -> unit = "void" "CamIL.String" "fill_string" "char[]" "int" "int" "char"
...
(* version standard external is_printable: char -> bool = "is_printable" *)
external char_code: char -> int = "%identity"
let is_printable x = let y = char_code x in y>31 (* STRICTCAML commenter la suite *)&& y<255  
