...
(* $Id: weak.ml,v 1.5 2003/10/27 07:06:41 montela Exp $ *)
...
external create: int -> 'a t = 
 "object[]" "CamIL.Weak" "weak_create" "int";;

external length: 'a t -> int = 
 "int" "CamIL.Weak" "length" "object[]";;

external set: 'a t -> int -> 'a option -> unit =
  "void" "CamIL.Weak" "weak_set" "object[]" "int" "object";;
external get: 'a t -> int -> 'a option = 
 "object" "CamIL.Weak" "weak_get" "object[]" "int";;
external get_copy: 'a t -> int -> 'a option = 
 "object" "CamIL.Weak" "weak_get_copy" "object[]" "int";;
external check: 'a t -> int -> bool =
 "int" "CamIL.Weak" "weak_check" "object[]" "int";;
